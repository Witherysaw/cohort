...
export default function AdminPanel() {
  ...
  return (
    <div className="flex h-screen">
      {/* Sidebar */}
      <div className="w-40 bg-slate-600 p-4 text-white">Sidebar</div>

      {/* Main Content */}
      <div className="flex-1 flex flex-col">
        {/* Top Menu */}
        <div className="h-20 bg-green-300 flex items-center justify-end px-10">
          <button
            className="bg-transparent border border-white text-white px-4 py-2 rounded-md hover:bg-white hover:text-black transition-all"
            onClick={logout}
          >
            Log Out
          </button>
